...
<div class="group">
    <h2 class="video-heading"><i>South of Market: The Musical v2</i></h2>
    <span style="float:right">October 2017</span>
</div>
...
<div class="group">
    <h2 class="video-heading"><i>South of Market: The Musical</i></h2>
...
<div class="group">
    <h2 class="video-heading">"Oh, the Sugars"</h2>
    <span style="float:right">October 2013</span>
</div>
...
<div class="group">
    <h2 class="video-heading"><i>Spotlight On...</i> &amp; <i>Rapid Fire</i></h2>
    <span style="float:right">July 2013</span>
</div>
...
<div class="group">
    <h2 class="video-heading"><i>Seasonal: i-iii.</i></h2>
    <span style="float:right">April 2013</span>
</div>
...
<div class="group">
    <h2 class="video-heading"><i>Seasonal: iv. No Ears</i></h2>
    <span style="float:right">February 2014</span>
</div>
...
<div class="group">
    <h2 class="video-heading">TEDxColumbiaCollege: <i>of Rain</i></h2>
    <span style="float:right">November 2012</span>
</div>

I arranged this looping cello/guitar performance from <i>of Rain</i>, the third movement of <i>Seasonal</i>. Andrew Bird inspired the live looping technique, which I implemented in Ableton Live, and can be heard beginning at <a id="time4">1:17</a>.
...
<div class="group">
    <h2 class="video-heading">V118: <i>The Corporate Core</i></h2>
    <span style="float:right">May 2012</span>
</div>
